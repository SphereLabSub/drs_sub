 ...
 * $Id: DOFrame.cpp 21836 2015-10-12 11:30:22Z ritt $
 */
...
char svn_revision[] = "$Id: DOFrame.cpp 21836 2015-10-12 11:30:22Z ritt $";

char drsosc_version[] = "5.0.4";
...
void DOFrame::UpdateControls()
{
   ...
   for (int i=0 ; i<4 ; i++) {
      ...
      m_osci->SetChnOn(0, i, m_chnOn[m_board][i]);
...
void DOFrame::LoadConfig(char *error, int size)
{
   ...
   if (fh < 0) {
      ...
      wxMessageBox(str, wxT("DRSOsc"), wxOK | wxICON_ERROR);
      return;
   }
   close(fh);
